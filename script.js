...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const startPauseButtonIcon = document.querySelector("#start-pause img.app__card-primary-button-icon");
    ...
    const music = new Audio("/sounds/healing-meditation-ringing-background-music-for-meditation-200223.mp3");
